...
* The original package name 'com.example.Gestion de prestamos' is invalid and this project uses 'com.example.Gestion.de.prestamos' instead.
...
* [Spring HATEOAS](https://docs.spring.io/spring-boot/3.4.10/reference/web/spring-hateoas.html)
